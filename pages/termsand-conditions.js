...
const TermsandConditions = (props) => {
  return (
    <>
      <div className="termsand-conditions-container1">
        <Head>
        ...
        <section id="Terms" className="termsand-conditions-section1">
          <header className="termsand-conditions-header1">
            ...
            <h2 className="termsand-conditions-heading1 section-heading">
          ...
          <main className="termsand-conditions-accordion">
            <span className="termsand-conditions-text100">
              ...
              <br></br>
                ...
                use of your data by Rinsee in the manner provided in this
                Privacy Policy.
              </span>
              <br className="termsand-conditions-text105"></br>
              <br className="termsand-conditions-text106"></br>
              <span className="termsand-conditions-text107">
                • As part of the registration process on the app, RINSEE may
              ...
              <br className="termsand-conditions-text108"></br>
              <br className="termsand-conditions-text109"></br>
              <span className="termsand-conditions-text110">
                • RINSEE will not use your financial information for any purpose
                other than to complete a transaction with you. RINSEE does not
                ...
                products or services you&apos;ve requested and such information
                is necessary to provide these products or services the
                information may be shared with RINSEE business associates and
                partners. RINSEE may, however, share consumer information on an
                aggregate with its partners or third parties where it deems
                necessary. In addition, RINSEE may use this information for
              ...
              <br className="termsand-conditions-text111"></br>
              <br className="termsand-conditions-text112"></br>
              <span className="termsand-conditions-text113">
                • To protect against the loss, misuse and alteration of the
                information under its control, RINSEE has in place appropriate
                physical, electronic and managerial procedures. For example,
                RINSEE servers are accessible only to authorized personnel and
                your information is shared with employees and authorised
                personnel on a need to know basis to complete the transaction
                and to provide the services requested by you. Although RINSEE
                ...
                site, you agree that RINSEE will have no liability for
                disclosure of your information due to errors in transmission or
                unauthorized acts of third parties.
              </span>
              <br className="termsand-conditions-text114"></br>
              <br className="termsand-conditions-text115"></br>
              <span className="termsand-conditions-text116">
                • RINSEE reserves the right to change or update this policy at
              ...
              <span className="termsand-conditions-text122">
              ...
              <span className="termsand-conditions-text176">
                ...
                in the quantity shown in the app after pickup and the quantity
              ...
              <span className="termsand-conditions-text179">
                ...
                consent. If any damage or stain happens after this stage, then
                we will strive to rectify it. If we are unable to rectify the
              ...
              <span className="termsand-conditions-text182">
                ...
                not detectable defects such as: insufficient resistance of
                fabrics or the seams, bad reaction of the colours or the
                impressions, presence of a pen in the lining, former defects,
                deterioration of the buttons, loops, zippers, shoulder pads,
                ornaments, etc., or if the label of maintenance is incorrect. A
                responsibility for contracting or modification of the colours
                remaining in the usual tolerances is excluded. The company aims
                to provide the best quality of cleaning available as per its
                standard methods; however, does not guarantee the removal of all
                stains on an article. Stain removal is a very complicated
                process and we do not guarantee stain removal in any case.
                Whenever possible, the company will notify the customer of
                stains and issues that cannot be resolved due to further
                possible damage to the fabric. The need for a particular
                treatment must be obvious especially in the event of delicate
                characteristics of the textile easily recognizable or stains
              ...
              <span className="termsand-conditions-text185">
                ...
                environment. We welcome your feedback at all times and will
        ...
        <section className="termsand-conditions-section3">
          <main className="termsand-conditions-content1">
            <header className="termsand-conditions-header2">
              <h2 className="section-heading">
                Stop searching online for Laundry and use Rinsee app!
              </h2>
              <div className="termsand-conditions-buttons">
                <div className="termsand-conditions-ios button">
                  <img
                    alt="image"
                ...
                >
                  <div className="termsand-conditions-android button">
                    <img
                      alt="image"
        ...
        <footer className="termsand-conditions-footer">
          <div className="termsand-conditions-content2">
            <main className="termsand-conditions-main-content">
              <div className="termsand-conditions-content3">
                <header className="termsand-conditions-main">
                  ...
                  <div className="termsand-conditions-socials">
                    <a
                      href="https://www.linkedin.com/company/rinsee"
                      target="_blank"
                      rel="noreferrer noopener"
                      className="termsand-conditions-link2"
                    >
                      <img
                        alt="image"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer noopener"
                      className="termsand-conditions-link3"
                    >
                      <img
                        alt="image"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer noopener"
                      className="termsand-conditions-link4"
                    >
                      <img
                        alt="image"
                ...
                <header className="termsand-conditions-categories">
                  <div className="termsand-conditions-category1">
                    ...
                    <div className="termsand-conditions-links1">
                      ...
                      <Link legacyBehavior href="/termsand-conditions">
              ...
              <section className="termsand-conditions-copyright1"></section>
            </main>
            <main className="termsand-conditions-subscribe"></main>
            <section className="termsand-conditions-copyright2"></section>
          </div>
        </footer>
        <div>
          <div className="termsand-conditions-container3">
          <Script
  html={`<script>
    if (!window.listenForUrlChangesMobileMenu) {
      window.listenForUrlChangesMobileMenu = () => {
    ...
    if (!window.runMobileMenuCodeEmbed) {
      window.runMobileMenuCodeEmbed = () => {
...
></Script>
      ...
      <style jsx>
        {`
          .termsand-conditions-container1 {
            width: 100%;
            display: flex;
            overflow: auto;
            min-height: 100vh;
          ...
          .termsand-conditions-heading1 {
            text-align: center;
          }
          .termsand-conditions-accordion {
          ...
          .termsand-conditions-ios {
            gap: var(--dl-space-space-halfunit);
            display: flex;
            flex-direction: row;
            background-color: #0f0f0f;
          }
          .termsand-conditions-icon1 {
            width: 16px;
            object-fit: cover;
          }
          ...
          .termsand-conditions-link1 {
            display: contents;
          }
          .termsand-conditions-android {
            gap: var(--dl-space-space-halfunit);
            display: flex;
            flex-direction: row;
          ...
          .termsand-conditions-main-content {
            gap: var(--dl-space-space-fiveunits);
            flex: 1;
            height: 100%;
            display: flex;
          ...
          .termsand-conditions-link2 {
            display: contents;
          }
          .termsand-conditions-link3 {
            display: contents;
          }
          .termsand-conditions-link4 {
            display: contents;
          }
          ...
          .termsand-conditions-copyright2 {
            gap: var(--dl-space-space-fiveunits);
            flex: 1;
            width: 100%;
            border: 2px dashed rgba(120, 120, 120, 0.4);
          ...
          .termsand-conditions-container3 {
            display: contents;
          }
